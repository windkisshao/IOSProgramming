...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //获取指向NSBundle 对象的指针，该NSBundle对象代表应用的主程序包
    NSBundle *appBundle = [NSBundle mainBundle];
    
//    BNRReminderViewController *rv = [[BNRReminderViewController alloc] initWithNibName:@"BNRReminderViewController" bundle:appBundle];
    BNRReminderViewController *rv = [[BNRReminderViewController alloc] init];
...
//    self.window.rootViewController = hvc;
    ...
    tabBarController.viewControllers = @[hvc,rv,qv];
